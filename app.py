...
app = Flask(__name__)
model = LinearRegressionModel.load("hdfs://localhost:9000/prediction_stock_price_data_model")
data = spark.read.parquet("hdfs://localhost:9000/user/lenovo/testdata")
